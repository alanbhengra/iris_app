...
s_length = st.slider('Sepal Length' , 0.00 , 10.0)
s_width = st.slider('Sepal width' , 0.00 , 10.0)
p_length = st.slider('Petal length' , 0.00 , 10.0)
p_width = st.slider('Petal width', 0.00 , 10.0)
